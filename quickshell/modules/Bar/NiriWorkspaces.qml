...
Item {
  ...
  function updateWorkspaces(arr) {
    arr.forEach(function(w){ w.populated = w.active_window_id !== null })
  ...
  Component.onCompleted: if (useNiri) seedInitial()
  ...
  //─── ROOT MOUSEAREA: HOVER→EXPAND, LEAVE→COLLAPSE ───────
