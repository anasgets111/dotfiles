...
OModal {
  ...
  readonly property var monitorOptions: [{label: qsTr("All displays"), value: "all"}].concat((WallpaperService.monitors ?? []).filter(monitor => monitor?.name).map(monitor => ({label: monitor.name, value: monitor.name})))
  ...
  readonly property var transitionOptions: (WallpaperService.availableTransitions ?? []).map(transition => ({label: ({fade: qsTr("Fade"), wipe: qsTr("Wipe"), disc: qsTr("Disc"), stripes: qsTr("Stripes"), portal: qsTr("Portal")})[transition] ?? transition, value: transition}))
    ...
    RowLayout {
          ...
          delegate: Item {
            ...
            ClippingRectangle {
              ...
              Rectangle {
                ...
                width: height
                OText { anchors.centerIn: parent; color: Theme.textContrast(parent.color); size: "xs"; text: "󰄬" }
              }
            }
          }
        }
      ...
      PanelCard {
        ...
        ColumnLayout {
          ...
          OText { bold: true; font.pixelSize: Theme.fontLg; text: qsTr("Wallpaper settings") }
          OText { color: Theme.textInactiveColor; size: "xs"; text: qsTr("Monitor") }
          OComboBox {
            Layout.fillWidth: true
          ...
          OText { color: Theme.textInactiveColor; size: "xs"; text: qsTr("Transition") }
          OComboBox {
            Layout.fillWidth: true
          ...
          OText { color: Theme.textInactiveColor; size: "xs"; text: qsTr("Theme") }
          OComboBox {
            Layout.fillWidth: true
