...
Item {
  ...
  readonly property color batteryColor: percentage <= BatteryService.criticalThreshold ? Theme.critical : percentage <= BatteryService.lowThreshold ? Theme.warning : Theme.activeColor
