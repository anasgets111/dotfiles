...
Item {
  ...
  function finalizeSessionSelection() {
    if (greeterState.sessionList.length === 0 || !greeterMemory.ready)
      return;
    ...
    onLoaded: {
      ...
      for (const line of text().split("\n")) {
        ...
        if (uid < 1000 || uid >= 60000)
          continue;
        if (p[6].endsWith("/nologin") || p[6].endsWith("/false"))
          continue;
  ...
  Rectangle {
    ...
    gradient: Gradient {
      GradientStop {
        color: theme.withOpacity(theme.activeColor, 0.08)
        position: 0.0
      }
      GradientStop {
        color: "transparent"
    ...
    ColumnLayout {
      ...
      Text {
        ...
        font {
          ...
          pixelSize: theme.fontHero
          weight: Font.Bold
        }
      }
      Text {
        Layout.fillWidth: true
        Layout.topMargin: theme.spacingSm * 0.5
              ...
              RowLayout {
                ...
                Text {
                  ...
                  font {
                    ...
                    weight: parent.parent.isSelected ? Font.DemiBold : Font.Normal
                  }
                }
              }
              MouseArea {
        ...
        Rectangle {
          ...
          Text {
            ...
            text: {
              ...
              return src.split(" ").filter(Boolean).slice(0, 2).map(p => p[0]?.toUpperCase() ?? "").join("") || "U";
            }

            font {
              family: theme.fontFamily
              pixelSize: Math.round(theme.fontHero * 0.7)
              weight: Font.Bold
            }
          }
        }
      ...
      Text {
        ...
        font {
          family: theme.fontFamily
          pixelSize: Math.round(theme.fontXl * 1.2)
      ...
      Rectangle {
        ...
        border.color: isFail ? theme.critical : greeterState.unlocking || Greetd.state !== GreetdState.Inactive ? theme.activeColor : inputField.activeFocus ? theme.activeColor : theme.withOpacity("#ffffff", 0.18)
        border.width: 2
        color: theme.bgInput
        ...
        RowLayout {
          ...
          TextInput {
            ...
            Text {
              ...
              text: greeterState.unlocking ? "Logging in…" : Greetd.state !== GreetdState.Inactive ? "Authenticating…" : "Password…"
      ...
      Text {
        Layout.fillWidth: true
        Layout.topMargin: theme.spacingSm
        color: greeterState.pamState === "fail" ? theme.critical : greeterState.pamState === "error" ? theme.warning : theme.withOpacity(theme.textActiveColor, 0.45)
        horizontalAlignment: Text.AlignHCenter
        text: greeterState.pamState === "fail" ? "Incorrect password" : greeterState.pamState === "error" ? "Authentication error" : greeterState.username ? "Press Enter to authenticate" : ""
        ...
        font {
          family: theme.fontFamily
          pixelSize: Math.round(theme.fontMd * 0.9)
        }
      }
      Item {
          ...
          Repeater {
            ...
            Rectangle {
              ...
              MouseArea {
                ...
                onClicked: greeterState.currentSessionIndex = index
              }
            }
          }
        }
