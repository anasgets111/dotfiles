...
if status is-interactive
    ...
    # Check for binaries using command -q (slightly faster) or type -q
    type -q zoxide; and zoxide init fish --cmd cd | source
    type -q starship; and starship init fish | source

    # 4. Theme
    # Optimization: Loading the theme every time can be slow. 
    # It is recommended to run this once manually: fish_config theme save "Catppuccin Mocha"
