...
return function(id)
    ...
    -- A button spanning the row: its label toggles the grid and its right end carries the age of
    -- the reading.
    local toggle = button {
        width = "Fill",
        ...
        children = {
            row {
                ...
                children = {
                    ...
                    -- No tooltip text: a tooltip is its own popup surface here.
            ...
            -- Two strings, bare centred text rather than a card. Its Retry button is absent: the
            -- refresh above is the same click, always there.
