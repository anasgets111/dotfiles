-- Radio tile: glyph over a word, whole tile a button, accent-lit when on. Side-by-side tiles put
-- wi-fi beside ethernet; a filled ground means "this is on" (`modules/bar/panels/power_menu.lua`),
-- matching radio state.
