...
Never use: component, service, API, boundary. Use the engine's `CONTEXT.md` for domain terminology and respect its ADRs (`DECISIONS.md` in `/mnt/Work/0Coding/1Rust/mantle`).
