...
1. **The YAGNI Gate (Round 0):** Does this need to exist? Can standard FOSS, native features, or existing logic (e.g., a Mantle capability, the Lua API, a `lib/` helper, a compositor feature) handle this? 
