...
## 0. Redact & Read
*   **Context:** Identify the layer: Obelisk shell Lua (`obelisk/.config/obelisk/`), Hyprland Lua (`hypr/.config/hypr/`), or the engine under them. For engine behavior, read `docs/lua-api.md` and `CONTEXT.md` in the engine checkout (`/mnt/Work/0Coding/1Rust/obelisk-engine`).
